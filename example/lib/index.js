...
/**
* Adding metadata as JSON object
* @param {Object} [metadata] - sets metadata
* @return {Object}
*/
Frame.prototype.meta = function(metadata) {
...
Frame.prototype._process = function() {
  ...
  for(let i = 0; i < this.files.length; i++) {
    this.plugins.forEach(function(plugin) {
      this.files[i] = plugin(this.files[i],this)
    },this)
  }
}
/**
